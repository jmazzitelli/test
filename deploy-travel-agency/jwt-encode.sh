...
# Kiali issuers: kiali-token kiali-openshift, kiali-login, kiali-token, kiali-ldap, kiali-open-id
iss="${ISS:-kiali-open-id}"

# When the session expires in epoch seconds - by default, expire it next Satuday
